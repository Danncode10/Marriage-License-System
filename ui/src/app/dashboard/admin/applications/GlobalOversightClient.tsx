    ...
    const handleDownloadExcel = async (app: any) => {
        ...
        try {
            ...
            const excelData = {
                ...
                gStatus: app.groom?.civil_status || 'Single',
                gDissolvedHow: app.groom?.dissolved_how || '',
                gDissolvedPlace: app.groom?.dissolved_place || '',
                gDissolvedCountry: app.groom?.dissolved_country || '',
                gDissolvedDate: app.groom?.dissolved_date || '',
                gRelationshipDegree: app.groom?.relationship_degree || '',
                ...
                bStatus: app.bride?.civil_status || 'Single',
                bDissolvedHow: app.bride?.dissolved_how || '',
                bDissolvedPlace: app.bride?.dissolved_place || '',
                bDissolvedCountry: app.bride?.dissolved_country || '',
                bDissolvedDate: app.bride?.dissolved_date || '',
                bRelationshipDegree: app.bride?.relationship_degree || '',
